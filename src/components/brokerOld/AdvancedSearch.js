...
import { Chip, List, IconButton, Badge  } from 'react-native-paper';
...
import { PO_BOX_BANNER, SEARCH_BY_LOC_BANNER, QCOMP_BANNER_2, QCOMP_BANNER_3, QCOMP_BANNER_4, QCOMP_BANNER_5, QCOMP_BANNER_6, QCOMP_BANNER_7, QCOMP_BANNER_8 } from '../../constants/banners';
    	...
    	<View style={[styles.searchBoxBlue]}>
			...
			<View>
    			...
    			<View style={styles.stackedLayout}>
	    			<View style={styles.justifiedLayout}>
				    	<Text style={[styles.textMediumBoldGray, {marginRight:5, width:150}]}>{QCOMP_BANNER_3}</Text>
...
export default connect(mapStateToProps, { onRedirect, homeLoanUpdated, borrowingUpdated, userLoanPreference, updateDealInFocus, hideDealOverlay })(AdvancedSearch);