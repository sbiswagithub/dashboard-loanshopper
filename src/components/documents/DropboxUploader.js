...
class DropboxUploader extends Component {
    constructor(props) {
	    super(props);
	}
...
export default connect(mapStateToProps, { toEmailMode, toGoogleDriveMode, toDropboxMode, hideDocumentUploaderModal })(DropboxUploader);