...
export const ACCEPTANCE_BANNER =  "I acknowledge that any information provided by you will be shared with affiliated mortgage brokers of Loan Analysis Solutions";
...
export const LOAN_PROCESSING = "Loan urgency";
export const RATE_PREFERENCE = "Rate preference";
export const FIRST_PREFERENCE = "Most prefered loan option";
